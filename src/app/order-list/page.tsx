...
import { Package, ShoppingCart, Search, Calendar, ChevronRight, X, Printer, CheckCircle } from 'lucide-react';
          ...
          <table className="w-full text-left border-collapse min-w-max">
            <thead>
              <tr className="bg-indigo-50/70 border-b border-indigo-100">
                <th className="px-4 py-3 text-[13px] font-bold text-indigo-900">주문일시</th>
                <th className="px-4 py-3 text-[13px] font-bold text-indigo-900">주문자 (이름/연락처)</th>
                <th className="px-4 py-3 text-[13px] font-bold text-indigo-900">주문상품 (상품명/입금자명)</th>
